...
export default function Portfolio() {
    const portfolio = [
        ...
        },
        {
            ...
            description: "The React User App Management is a web application built with React that allows users to easily manage profiles by adding, editing, and deleting them. It supports different user types (admin, editor, user) and includes features like form validation, error handling, and a responsive design for both desktop and mobile. Using React, React Bootstrap, and the Context API, the app provides a clean, intuitive interface for seamless user management.",
            image: 'https://i.ibb.co/cjqfJMd/User-App-Management-02-08-2025-11-56-AM.png',
            link: 'https://xpertdude.github.io/user-app-management/'
        }
    ]
    ...
    return <>
        ...
        <section className="container-fluid gap-5 row modal-container justify-content-center align-items-center">
            {handleShow && <DisplayProjectModal />}
            {portfolio.length > 0 &&
                portfolio.map(item => (
                    <div key={item.id} className="col-sm-12 col-md-6 col-lg-4 mb-5 cart">
                        <div className="card">
